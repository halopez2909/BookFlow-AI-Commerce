...
class CatalogClient:
    async def get_books(self, title=None, author=None, category_id=None, page=1, page_size=20, min_price=None, max_price=None, available=None) -> dict:
        async with httpx.AsyncClient(timeout=15) as client:
            ...
            if available is not None: params["available"] = available
...
with open("bff-bookflow/app/infrastructure/clients/catalog_client.py", "w", encoding="utf-8") as f:
    f.write(content)
print("catalog_client.py updated")
